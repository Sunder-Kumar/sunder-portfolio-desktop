...
export default function Achievements() {
  ...
  return (
    <div className="p-6 h-full overflow-y-auto text-gray-200 relative bg-[#161626]">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-white flex items-center gap-2">
          <Trophy className="w-6 h-6 text-yellow-400" />
          Achievements
        </h2>
        <div className="h-0.5 w-16 bg-gradient-to-r from-yellow-400 to-transparent mt-1 rounded-full" />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {achievements.map((achievement, index) => (
          <div
            key={index}
            className="group relative rounded-xl overflow-hidden border border-white/10 bg-[#1a1a2e] cursor-pointer hover:border-white/20 transition-colors"
          ...
          >
            {achievement.image ? (
              ...
              <div className="aspect-video w-full flex flex-col items-center justify-center p-6 text-center bg-[#0f0f1a]">
