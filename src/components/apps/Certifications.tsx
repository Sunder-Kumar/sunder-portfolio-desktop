...
export default function Certifications() {
  ...
  return (
    <div className="p-6 h-full flex flex-col overflow-hidden text-gray-200 bg-[#161626]">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          ...
          <div className="h-0.5 w-16 bg-gradient-to-r from-orange-400 to-transparent mt-1 rounded-full" />
        </div>
      ...
      <div className="flex-1 overflow-y-auto pr-2">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-6">
          {filteredCerts.map((cert, index) => (
            <div
              key={index}
              className="bg-[#1a1a2e] border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition-all flex flex-col h-full"
            >
              <div
                className="aspect-video bg-[#0f0f1a] relative cursor-pointer group"
              ...
              <div className="p-4 flex flex-col flex-1 bg-[#1a1a2e]">
