...
const SIDEBAR_ITEMS = [
  { id: "about", label: "About Sunder", icon: "User" },
...
export function Finder() {
  ...
  return (
    <div className="flex h-full w-full bg-[#1a1a2e] text-white/90">
      {/* Sidebar */}
      <div className="w-[220px] bg-[#13131f] border-r border-white/10 flex flex-col">
      ...
      <div className="flex-1 flex flex-col bg-[#1e1e2e]">
        <div className="h-12 border-b border-white/10 flex items-center px-4 gap-4 bg-[#13131f]">
          <button 
            ...
            <div className="space-y-4">
              <div>
                <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                  <LucideIcons.Folder className="w-6 h-6 text-blue-400" />
                  Sunder Portfolio
                </h2>
