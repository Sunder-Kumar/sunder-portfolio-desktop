...
import { Code, Bot, Brain, LayoutTemplate, Wrench, Cpu, LucideIcon } from 'lucide-react';
...
export default function Skills() {
  ...
  return (
    <div className="p-6 h-full overflow-y-auto text-gray-200 bg-[#161626]">
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-white flex items-center gap-2">
          <Cpu className="w-6 h-6 text-purple-400" />
          Skills &amp; Expertise
        </h2>
        <div className="h-0.5 w-16 bg-gradient-to-r from-purple-400 to-transparent mt-1 rounded-full" />
      </div>
