  ...
  const handleCommand = (cmd: string) => {
    ...
    switch (trimmedCmd) {
        ...
        output = (
          <div className="text-green-400 space-y-1">
            ...
            <ul className="list-disc list-inside ml-4">
              ...
              <li>about - Information about Sunder</li>
      ...
      case 'community':
        ...
        break;
      case 'resume':
        output = <a href="/assets/resume/Sunder_Resume_.pdf" download className="text-blue-400 underline hover:text-blue-300">Download Resume</a>;
        break;
      case 'contact':
        output = (
          <div>
  ...
  return (
    ...
    >
      <div className="mb-4 text-green-400">
        Welcome to Sunder&apos;s Terminal<br />
