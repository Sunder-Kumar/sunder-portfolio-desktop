...
import AskSunder from '../apps/AskSunder';
...
const APP_MAP: Record<string, { component: React.ComponentType; label: string; icon: React.ReactNode }> = {
  ...
  asksunder: { component: AskSunder, label: 'Ask Sunder', icon: <Sparkles size={22} /> },
};
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-6 space-y-8">
          ...
          <div className="text-center mt-10">
            ...
            <h1 className="text-4xl font-bold tracking-tight mb-1">Sunder Kumar</h1>
          ...
          >
            ...
            <span className="font-semibold text-lg">Ask Sunder</span>
          </button>
